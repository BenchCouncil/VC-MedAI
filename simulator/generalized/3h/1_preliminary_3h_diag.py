...
def objective(trial,train_x,train_y,val_x,val_y,test_x,test_y,model_path,kforder):
    params = {
        ...
        'min_child_weight': trial.suggest_float('min_child_weight', 5, 10.0),
        'reg_lambda': trial.suggest_float('reg_lambda', 0, 10),
        'reg_alpha': trial.suggest_float('reg_alpha', 0, 10),
        'scale_pos_weight': trial.suggest_float('scale_pos_weight',0.9, 1.3),#用了重复采样保持正负样本比例均衡，不然灵敏度和差异度相差太大
